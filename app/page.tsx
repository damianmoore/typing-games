    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
          ...
          {/* Starting Letter Game Card */}
          <Link href="/starting-letter">
            <div className="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow cursor-pointer">
              <div className="card-body">
                <h2 className="card-title text-2xl">Starting Letter</h2>
                <p>See an emoji, hear its name, and type the first letter. Perfect for learning letter sounds!</p>
                <div className="card-actions justify-end mt-4">
                  <button className="btn btn-primary">Play Now</button>
                </div>
              </div>
